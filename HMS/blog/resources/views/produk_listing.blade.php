...
<html lang="en"
    ...
    <body class="layout-default">
                                ...
                                <div class="flex">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item active">PO ADMIN</li>
                                        </ol>
                                    </nav>
                                    <h1 class="m-0">PO ADMIN</h1>
                                </div>
                                <a href=""
                                    ...
                                    <table class="table mb-0 thead-border-top-0 table-striped">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar bg-success"
                                                ...
                                                <th style="width: 100px; text-align: right;">
                                                    <div class="dropdown pull-right">
                                                        <th > <button>Print</button> <button>Detail</button></th>
      ...
      'fixed': 'fixed-product-listing.html',
      'fluid': 'fluid-product-listing.html',
      'mini': 'mini-product-listing.html'
    }"></app-settings>
        </div>
